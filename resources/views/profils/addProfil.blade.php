				...
				<div class="container-fluid">
					...
					<div class="row heading-bg">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						  <h5 class="txt-dark">Nouveau Profil</h5>
						</div>
						<!-- Breadcrumb -->
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
						  <ol class="breadcrumb">
							...
							<li class="active"><span>ajout profil</span></li>
						  </ol>
						</div>
						<!-- /Breadcrumb -->
					</div>
									...
									<div class="panel-body">
										<div class="form-wrap">
											<form action="{{ url('storeProfil') }}" method="POST">
												...
												<h6 class="txt-dark capitalize-font"><i class="zmdi zmdi-calendar-note mr-10"></i>Ajout Profil</h6>
												<hr class="light-grey-hr"/>
												
												<div class="row">
													<div class="col-sm-12">
														<div class="form-group">
															<input type="text" name="nameProfil" class="form-control" placeholder="Nouveau Profil">
														</div>
													</div>
